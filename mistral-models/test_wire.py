"""Mistral: what core asks of a call is in the request the model receives.
...
def _entry(url: str) -> ProviderEntry:
    ...
    return ProviderEntry(name="wire", type="mistral", model="", options=form_options(APP_DIR, url))
