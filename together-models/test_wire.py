"""Together: what core asks of a call is in the request the model receives.
...
def _entry(url: str) -> ProviderEntry:
    ...
    return ProviderEntry(name="wire", type="together", model="", options=form_options(APP_DIR, url))
