"""Google Gemini (chat): what core asks of a call is in the request the model receives.
...
def _entry(url: str) -> ProviderEntry:
    ...
    return ProviderEntry(name="wire", type="google", model="", options=form_options(APP_DIR, url))
