...
``delete_model``). Posting a Discord message is exactly that class of
write — it is outward-facing, instantly visible to everyone in the channel, and
only reversible by a second API call that leaves an edit/delete trace — so this
transport honors the same switch.
